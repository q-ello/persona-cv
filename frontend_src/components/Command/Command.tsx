...
const Command = () => {
  ...
  return (
    <div className='text-9xl -rotate-15 text-white select-none'>
        {/* c */}
        <span className="font-cooper font-black inline-block scale-125">C</span>
        {/* o */}
        ...
        <span className="overflow-hidden inline-block leading-none translate-y-8 rotate-10 py-5">
          <span className="p-1 pb-3 font-cooper font-black bg-white inline-block -rotate-20 -skew-x-5">
            <span className="text-black inline-block rotate-10 skew-x-5">M</span>
          </span>
        </span>
        {/* a */}
        <span className="font-cooper font-black scale-125 inline-block persona-outline text-black -ml-5 -rotate-10 translate-y-2 z-10 relative">a</span>
        {/* n */}
        <span className="font-calaboose persona-reverse-outline inline-block scale-x-75 -ml-5 -translate-y-1 rotate-5">n</span>
        {/* d */}
        <span className="font-cooper font-black inline-block -rotate-5 -ml-4 translate-y-3">D</span>
      </div>
  )
}
